...
<div className='flex flex-col lg:flex-row  mb-2'>
    <div className='bg-blue-400 h-60  lg:w-[30%]'>
<img src="./src/assets/cultureSection1.jpg" alt="culture" className='p-4 h-60 w-screen' />
    </div>
<div   style={{ backgroundImage: `url(${bgImage})` }} className='bg-cover relative lg:w-full brightness-70 bg-center h-60  lg:brightness-90'>
...
<div className='gap-2'>
  ...
  ' className='border-1 border-white m-3  w-fit  rounded-sm placeholder:bg-white' />
