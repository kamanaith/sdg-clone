...
setRotation((prev) => (prev + 1) % 360)},50);
...
<div className='text-5xl text-[#329BD5] text-center py-8 gap-2 '><h1><b>SDG Foundation</b></h1></div>
    ...
    <div className='flex flex-col  bg-[#329BD5] items-center lg:flex-row lg:w-full lg:justify-between '>
      ...
      <div className="relative justify-center flex items-center w-80 h-80 sm:w-60 sm:h-60 md:w-120 md:h-120 lg:mr-20 " style={{ transform: `rotate(${rotation}deg)`, transition: "transform 0.1s linear" }}>
        <img src={rotate1} alt="Spinning Image" className="w-full h-full absolute " />
        <img src={rotate2}  alt="Earth" className="absolute   m-auto w-35 h-35 sm:w-24 sm:h-24 md:w-60 md:h-60" />
      </div>
