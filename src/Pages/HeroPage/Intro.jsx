...
<div className='text-5xl text-blue-400 text-center py-8 gap-2 '><h1><b>SDG Foundation</b></h1></div>
        ...
        <div className='text-blue-400 font-semibold text-lg px-6 text-justify lg:text-xl xl:text-2xl'>
    ...
    <div className='flex flex-col  bg-blue-400 items-center lg:flex-row lg:w-full lg:justify-between '>
        
          <img src="./src/assets/rotate/rotate3.png" alt="image" className=' p-2 lg:w-1/2 ' />
